...
Section "Delete Red Star skins"
  ...
  RMDir /r "$INSTDIR\f-14a-135-gr\RED STAR F-14A-135-GR"
  RMDir /r "$INSTDIR\f-14b\RED STAR F-14B"
...
Section "Delete Red Star BLACK SQUADRON skins"
  ...
  RMDir /r "$INSTDIR\f-14a-135-gr\RED STAR F-14A-135-GR BLACK SQUADRON"
  RMDir /r "$INSTDIR\f-14b\RED STAR F-14B BLACK SQUADRON"
  RMDir /r "$INSTDIR\f-15c\RED STAR F15C BLACK SQUADRON"
...
SectionGroup "Red Star BLACK SQUADRON"
  ...
  Section "F-14B"
    SetOutPath $INSTDIR\f-14b
    File /r "f-14b\RED STAR F-14B BLACK SQUADRON"
  SectionEnd
  Section "F-15C"
    SetOutPath $INSTDIR\f-15c
